...
static uint16_t StateEnd_Width[5] = {2560,2575,2527,2430,1200};		//状态最终脉宽
static uint16_t Target_Width[5] = {2560,2575,2527,2430,1200};			//当前周期目标脉宽
...
void MechanicalArm_IncRun(uint16_t Width,uint8_t Inc);		//
...
void MechanicalArm_WidthInc(void);							//脉宽递增
